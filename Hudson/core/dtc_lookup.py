...
def lookup(code: str, manufacturer: str = "generic") -> tuple[str, str] | None:
    """Look up a DTC code.
...
def lookup_description(code: str, manufacturer: str = "generic") -> str:
    result = lookup(code, manufacturer)
